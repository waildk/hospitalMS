        ...
        <div class="container">
            ...
            <div class="box box-primary" >
                <div class="box-body">
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >{{ __("Add New appointment") }}</div>
                    ...
                    <div class="form-group">
                        ...
                        @error('nurse') <span class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="end_time" class="form-control" placeholder="Set End Time Of Appointment" wire:model.lazy="start_timeee" />
                        <p class="text-info">Current Value: {{ $start_timeee }}</p>
                        @error('start_timeee') <span class="text-red-500 text-danger text-xs">{{ $message }}</span> @enderror
                    </div>
                    ...
                    <div class="text-capitalize bg-dark p-2 shadow mb-3 text-center text-lg text-light rounded" >{{ __("All  appointments") }}</div>
                            ...
                            @forelse ($appointments as $appointment)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        <button wire:click="delete({{ $appointment->id }})" onclick="return confirm('{{ __('Are You Sure ?')  }}')" class="btn btn-outline-danger btn-rounded"><i class="fas fa-trash"></i></button>
                                    </td>
                                </tr>
                            @empty
